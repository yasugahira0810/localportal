# v0.0.7 (2017/04/05リリース)

![v0.0.7のスクリーンショット](img/screen_shot_v0.0.7.png)

## 追加機能

- CASE INSENSITIVE検索（英字の大文字小文字を区別しない検索）
- [GitHub Pages対応](https://yasugahira0810.github.io/localportal/)

## Bug Fix

- INSERT直後のリンクが正しくソートされないバグを修正
